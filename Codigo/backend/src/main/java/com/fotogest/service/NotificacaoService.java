...
import com.fotogest.model.NotificacaoDispensada;
...
import com.fotogest.repository.NotificacaoDispensadaRepository;
...
public class NotificacaoService {
    ...
    public List<NotificacaoResponse> listar() {
        ...
        List<NotificacaoResponse> notificacoes = gerarNotificacoes();
    ...
    private List<NotificacaoResponse> gerarNotificacoes() {
        List<Ensaio> ensaios = ensaioRepository.findAll();
        OffsetDateTime agora = OffsetDateTime.now();
        var albumPorEnsaio = albumRepository.findAll()
                .stream()
