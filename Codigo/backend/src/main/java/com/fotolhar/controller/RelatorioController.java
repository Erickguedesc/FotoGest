...
import com.fotolhar.service.RelatorioPdfService;
import com.fotolhar.service.RelatorioService;
...
public class RelatorioController {
    ...
    public ResponseEntity<byte[]> exportarFaturamentoPdf(
        ...
        String filename = "relatorio-fotolhar-" + tipo.name().toLowerCase() + "-" + anoFinal + ".pdf";
