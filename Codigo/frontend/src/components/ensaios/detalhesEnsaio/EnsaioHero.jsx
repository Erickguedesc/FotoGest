...
function CalendarIcon() {
  return (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" className="text-white/45">
...
export default function EnsaioHero({
  ...
  return (
    <section className="overflow-hidden rounded-[24px] border border-[var(--gold-border)] bg-[#121212]">
      <div className="grid min-h-[300px] grid-cols-[260px_1fr] max-lg:grid-cols-1">
        <div className="relative h-full min-h-[300px] bg-[#181818] max-lg:min-h-[240px]">
          {fotoCapa ? (
            <img
              src={fotoCapa}
          ...
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-transparent via-transparent to-[#121212]/10 max-lg:bg-gradient-to-t" />
        </div>
        ...
        <div className="flex items-center">
          <div className="w-full px-10 py-9 max-md:px-6 max-md:py-7">
            ...
            <h1 className="mt-6 font-serif text-[56px] font-light leading-[1.05] tracking-[0.01em] text-white max-lg:text-[44px] max-md:text-[34px]">
              {ensaio?.clienteNome || 'Cliente sem nome'}
            </h1>

            <div className="mt-6 flex flex-wrap items-center gap-x-7 gap-y-3 text-[14px] text-white/78">
  ...
  <button
    ...
    className="inline-flex items-center gap-2 rounded-[12px] border border-white/[0.10] bg-transparent px-5 py-3 text-[13px] font-medium tracking-[0.06em] text-white/85 transition hover:border-[var(--gold-border)] hover:bg-[var(--gold-dim)] hover:text-white"
  >
    <FileIcon />
    Pré-contrato
  </button>
  ...
  <button
    type="button"
    onClick={onBack}
    className="inline-flex items-center gap-2 rounded-[12px] border border-white/[0.10] bg-transparent px-5 py-3 text-[13px] font-medium tracking-[0.06em] text-white/60 transition hover:border-[var(--gold-border)] hover:bg-[var(--gold-dim)] hover:text-white"
  >
    <BackIcon />
    Voltar
  </button>
